...
class ThirdPage: UICollectionViewCell {
    ...
    func LayOut() {
        ...
        [text, image, allowNotifications, setNotifications, doNotallowNotifications, setLocation, allowLocation].forEach {popUpView.addSubview($0)}
        UserDefaults.standard.set(0, forKey: "Notifications")
        UserDefaults.standard.set("07:00", forKey: "RemindHour")
        ...
        allowLocation.setTitle("Allow using location", for: .normal)
        ...
        allowLocation.anchor(top: setLocation.bottomAnchor, leading: nil, bottom: nil, trailing: nil, padding: .init(top: padding * 3, left: 0, bottom: 0, right: 0), size: .init(width: 175, height: 40))
        allowLocation.centerXAnchor.constraint(equalTo: popUpView.centerXAnchor).isActive = true
    }
